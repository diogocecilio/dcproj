...
P[0][0]=(4*sxx - 2*(syy + szz))/9.;P[0][1]=(-2*sxx - 2*syy + 4*szz)/9.;P[0][2]=(-2*sxx + 4*syy - 2*szz)/9.;P[0][3]=(2*sxz)/3.,P[0][4]=(-4*syz)/3.;P[0][5]=(2*sxy)/3.;

P[1][0]=(-2*sxx - 2*syy + 4*szz)/9.;P[1][1]=(-2*sxx + 4*syy - 2*szz)/9.;P[1][2]= (4*sxx - 2*syy - 2*szz)/9.;P[1][3]=(-4*sxz)/3.,P[1][4]=(2*syz)/3.;P[1][5]=(2*sxy)/3.;

P[2][0]=(-2*sxx + 4*syy - 2*szz)/9.;P[2][1]=(4*sxx - 2*syy - 2*szz)/9.;P[2][2]= (-2*sxx - 2*syy + 4*szz)/9.;P[2][3]=(2*sxz)/3.,P[2][4]=(2*syz)/3.;P[2][5]=(-4*sxy)/3.;

P[3][0]=(2*sxz)/3.;P[3][1]=(-4*sxz)/3.;P[3][2]=(2*sxz)/3.;P[3][3]=(2*(sxx - 2*syy + szz))/3.,P[3][4]=2*sxy;P[3][5]=2*syz;

P[4][0]=(-4*syz)/3.;P[4][1]=(2*syz)/3.;P[4][2]=(2*syz)/3.;P[4][3]=2*sxy,P[4][4]=(2*(-2*sxx + syy + szz))/3.;P[4][5]=2*sxz;

P[5][0]=(2*sxy)/3.;P[5][1]=(2*sxy)/3.;P[5][2]=(-4*sxy)/3.;P[5][3]=2*syz,P[5][4]=2*sxz;P[5][5]=(2*(sxx + syy - 2*szz))/3.;
...
// 	}
	...
	NRvector<Doub>  Yields ( NRtensor<Doub> tensor )
    {
		...
		yields[0]=phi1;yields[0]=phi2;yields[0]=phi3;
		return yields;
